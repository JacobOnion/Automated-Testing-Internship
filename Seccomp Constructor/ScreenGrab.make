...
ifeq ($(config),debug)
OBJDIR = obj/Debug/ScreenGrab
DEFINES += -DDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -fPIC -g
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -fPIC -g
ALL_LDFLAGS += $(LDFLAGS) -shared -Wl,-soname=libScreenGrab.so

else ifeq ($(config),release)
OBJDIR = obj/Release/ScreenGrab
DEFINES += -DNDEBUG
ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -O2 -fPIC
ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -O2 -fPIC
ALL_LDFLAGS += $(LDFLAGS) -shared -Wl,-soname=libScreenGrab.so -s
...
GENERATED += $(OBJDIR)/ScreenGrabLib.o
OBJECTS += $(OBJDIR)/ScreenGrabLib.o
